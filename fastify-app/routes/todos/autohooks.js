...
module.exports = fp(
  async function todoAutoHooks (fastify, opts) {
    ...
    fastify.decorateRequest('todosDataSource', null) // speed optimization. make the application aware of the todosDataSource prop at the beginning of the request lifecycle
